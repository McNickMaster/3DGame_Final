...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float camera_tilt_amount = 3;
    private float target_camera_tilt = 0;
    ...
    public void ChangeMaxSpeed(float newMax)
    {
        maxSpeed = newMax;
    }

    public void ChangeAcceleration(float newAccel)
    {
        moveSpeed = newAccel;
    }
